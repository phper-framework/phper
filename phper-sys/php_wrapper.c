...
typedef zend_class_entry* phper_init_class_entry_handler(
    zend_class_entry* class_ce,
    void* argument);

zend_class_entry* phper_init_class_entry_ex(
...
zend_string* phper_zend_string_init(const char* str,
                                    size_t len,
                                    int persistent) {
...
zval* phper_zend_hash_str_update(HashTable* ht,
                                 const char* key,
                                 size_t len,
                                 zval* pData) {
...
static zend_string* phper_zend_string_concat3(const char* str1,
                                              size_t str1_len,
                                              const char* str2,
                                              size_t str2_len,
                                              const char* str3,
...
typedef void (*phper_foreach_func_arg_t)(zend_ulong idx,
                                         zend_string* key,
                                         zval* val,
                                         void* argument);
